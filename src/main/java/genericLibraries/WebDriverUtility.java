 ...
 * @return 
 */
public WebElement expilicitWait(long time, WebElement element)
{
 ...
 * @return 
 */
public WebElement expilicitWait( WebElement element, long time)
{
	WebDriverWait wait = new WebDriverWait(driver, time);
	return wait.until(ExpectedConditions.elementToBeClickable(element));
}
/**
 * This method is used to wait until tile of web page is found
 * @param time
 * @param title
 * @return
 */
public boolean  expilicitWait(long time, String title)
{
	WebDriverWait wait = new WebDriverWait(driver, time);
...
/**
 * This method is used to drag and drop on element to  dest
 * @param element
 * @param dest
 */
...
{
	Actions actions = new Actions(driver);
	actions.dragAndDrop(element,dest);
}
/**
...
/**
 * This method is used to switch to frame based on id or name  attributes
 * @param idOrName
 */
...
/**
 * this method is used to close current tab or windows
 */
...
/**
 * This method is used to close all the tabls or windows
 */
